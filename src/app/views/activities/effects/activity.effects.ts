...
import {
    createActivity, getActivitySuccess, getActivityError, createActivityError, subscribeActivity,
    subscribeActivitySuccess, subscribeActivityError, deleteActivityError, editActivity, editActivitySuccess,
    editActivityError, deleteActivitySuccess, createActivitySuccess, getAllActivities,
    getAllActivitiesError, getAllActivitiesSuccess, deleteActivity, getActivity
} from '../actions';
